  ...
  return (
    <Section id="faq">
      ...
      <p className="mt-4 text-xs text-zinc-500">
        Disclaimer: Tokens are highly volatile, risky, and open for everyone to trade as they prefer. Nothing here is financial advice. Know the game you&#39;re playing &amp; always do your own research.
      </p>
    </Section>
  );
}
